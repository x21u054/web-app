...
.btn.btn-google {
	...
	/* top:50; bottom:25; left: 130px;; right:0; */
	margin: auto;
}
...
<body>
	<div class="container">
		<div class="card card-container">
			...
			<h1 class="rounded-end">
				アカウント新規<br>登録
			</h1>
			<form action="/test-4/email-verify" method="post" class="form-signin">
				<p id="validate_msg"></p>
				<input type="email" id="inputEmail" class="form-control"
					placeholder="メールアドレス" name="email" required autofocus>
				<button class="btn btn-lg btn-primary btn-block btn-google"
					type="submit">googleアカウントで登録</button>
				<p></p>
	...
	<script>
		function CheckEmail_1() {
			var email = document.getElementById("inputEmail").value; //メールフォームの値を取得
			var mdomain = email.substr(-17, 17);
			...
			if (mdomain === "@mitsuhashi.ac.jp") {
				...
				// 				alert("メールアドレスの形式が間違っています。"); // 一致していなかったら、エラーメッセージを表示する
